...
export function AccountChart({ transactions }) {
  ...
  return (
   <Card className="bg-white text-black dark:bg-[#0f172a] dark:text-white shadow-sm border border-gray-200 dark:border-gray-800">
  <CardHeader className="flex flex-row items-center justify-between pb-7">
    <CardTitle className="text-base text-2xl font-extrabold text-purple-900 dark:text-gray-100">
